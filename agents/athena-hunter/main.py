...
SQL_GEN_PROMPT = (
    ...
    "  Lead the answer with asset_classification's vendor/device_type/os when present, else "
    "the vendor_mac in known_devices. If BOTH inventory tables are empty for this MAC, you "
    "MUST still name the vendor from the OUI (first three octets), never say 'vendor "
    "unknown': 00:0c:29 and 00:50:56 = VMware, ac:de:48 = private, 00:1a:11 = Google, "
    "3c:5a:b4 = Google, b8:27:eb / dc:a6:32 = Raspberry Pi, and Apple/Intel/Samsung OUIs are "
    "well known. Also flag a locally-administered/randomized MAC (second hex digit 2,6,A,E).\n\n"
