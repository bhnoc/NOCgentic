...
SQL_GEN_PROMPT = (
    ...
    "  Lead the answer with asset_classification's vendor/device_type/os when present. If it "
    "is empty for this MAC, fall back to the vendor_mac in known_devices, and only then note "
    "the OUI. Also flag a locally-administered/randomized MAC (second hex digit 2,6,A,E).\n\n"
